...
package com.cardpop.app.data.repository
...
import com.cardpop.app.domain.usecase.backup.CreateBackupUseCase
...
class FlashcardRepository @Inject constructor(
    ...
    suspend fun getTotalFlashcardCount(): Int = flashcardDao.getTotalFlashcardCount()
    ...
    suspend fun getEnabledMatureCount(): Int = flashcardDao.getEnabledMatureCount()
